...
variable "openWebuiNamespace" {
  description = "The namespace in which openwebui charts are to be installed."
  type        = string
  default     = "openwebui"
}
...
variable "managedDisks" {
  description = "Azure Disks to be created for Persistence Data."
  type = map(object({
    name                    = string
    disk_size_gb            = string
...
variable "tempoSecretName" {
  description = "Tempo storage account secret name."
  type        = string
  default     = "tempo-traces-stg-key"
}

variable "tempoSecretKey" {
  description = "Tempo storage account secret key."
  type        = string
...
variable "lokiNumberOfReplicas" {
  description = "The number of replicas for Loki Pod(s). Minimum 3 because of SimpleScalable deploymentMode."
  type        = number
}

variable "ollamaNumberOfReplicas" {
  description = "The number of replicas for Ollama Pod(s)."
  type        = number
}
...
variable "role_definition_name" {
  description = "Assign an Azure role for access to blob data."
  type        = string
...
variable "azureAD_application_name" {
  ...
  type        = string
  default     = "azureDiskCsiDriverApplication"
}

variable "storageClassProvisioner" {
  description = "The Azure Disks Container Storage Interface (CSI) driver is a CSI specification-compliant driver used by Azure Kubernetes Service (AKS) to manage the lifecycle of Azure Disk."
  type        = string
  default     = "disk.csi.azure.com"
}

variable "kubernetesDashboardNamespace" {
  description = "Kubernetes Dashboard Namespace."
  type        = string
  default     = "kubernetes-dashboard"
}

variable "azure_disks_role_definition_name" {
  description = "Assign an Azure Disk role for access to blob data."
  type        = string
  default     = "Contributor"
}
...
variable "headlampReplicaCount" {
  description = "Number of desired pods for Headlamp GUI."
  type        = number
}
